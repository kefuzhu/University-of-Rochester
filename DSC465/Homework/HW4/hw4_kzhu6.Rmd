...
Suppose we label the cluster in $Q$ with $\{1,2,...,M\}$ and $R$ with $\{1,2,...,N\}$ and we know $M < N$

Since $R$ assigns a cluster to every data point, which satisfies the condition (i) in part(e): Each row of Table 1 has exactly one nonzero entry. So we can conclude $MI(A,B) = H(P_B)$
